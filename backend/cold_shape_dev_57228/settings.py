"""
Django settings for cold_shape_dev_57228 project.
...
ROOT_URLCONF = 'cold_shape_dev_57228.urls'
...
WSGI_APPLICATION = 'cold_shape_dev_57228.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cold_shape_dev_57228 API",
    "DESCRIPTION": "API documentation for cold_shape_dev_57228 App",
    "VERSION": "v1",
}
